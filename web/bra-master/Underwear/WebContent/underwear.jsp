...
<!-- banner -->
            ...
            <div class="banner_bottom_agile_info_inner_w3ls">
    	           <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="images/TB2amf_bz3z9KJjy0FmXXXiwXXa_!!3265150369.jpg" alt=" " class="img-responsive" />
							<figcaption>
					 ...
					 <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="images/TB2uVyLdsnI8KJjSsziXXb8QpXa_!!3265150369.jpg" alt=" " class="img-responsive" />
							<figcaption>
								<!--<h3><span>F</span>all Ahead</h3>-->
								<p>产品展示</p>
							</figcaption>			
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="images/商店2.jpg" alt=" " class="img-responsive" />
		</div>
					...
					<!--/tab_one-->
						<div class="tab1">
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/1A.jpg" alt="" class="pro-image-front">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/2A.jpg" alt="" class="pro-image-front">
										<img src="images/2A.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="#" class="link-product-add-cart">快速查看</a>
												</div>
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/3A.jpg" alt="" class="pro-image-front">
										<img src="images/3A.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="#" class="link-product-add-cart">快速查看</a>
												</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="images/4A.jpg" alt="" class="pro-image-front">
										<img src="images/4A.jpg" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="#" class="link-product-add-cart">快速查看</a>
												</div>
