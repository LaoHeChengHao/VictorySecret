...
<header>
    <section class="container-fluid vs-topNav">
        <a href="维多利亚的秘密.jsp"><img src="img/mobileLogo.png" class="visible-xs mobileLogo"/></a>
    </section>
    <section class="container vs-logoWrap">
        <div class="vs-logo hidden-xs">
            <a href="维多利亚的秘密.jsp"><img src="img/VSLogo.png"/></a>
        </div>
    </section>
</header>
<section class="container">
    <div class="terms">
        ...
        <p>Victoria's Secret（维多利亚的秘密）是享誉全球的女性内衣品牌，一年一度的时尚大秀和性感迷人的天使超模更让其成为全球瞩目的焦点。作为Lbrands旗下品牌之一，Victoria's
            Secret专注于女士内衣、高级香氛、身体护理、美妆配饰及运动休闲服饰等，在全球拥有超过1,600家门店，并于中国开设了维多利亚的秘密官方旗舰店，满足消费者随时随地选购心仪商品的需求。</p>

        <p><b>联系我们</b></p>

        <p>TB128老何项目小组</p>

        <p>地址：江苏省南京市秦淮区安德门97号TB128老何项目小组</p>

        <p>项目联系人:拾亿元小姐（9:00-18:00，周一至周日）</p>
        ...
        <div class="container ">
            <div class="row vs-footerRow">
                <div class="col-md-2 col-md-push-4 col-xs-12 findStoreBox">
                    <a href="http://192.168.10.110:8080/" class="vs-whiteLink footerStore">Victoria’s Secret合作假日酒店酒店</a>
                </div>
                <div class="col-md-2 col-md-push-4 col-xs-12 findStoreBox">
